    ...
    return [
      ...
      { group: "AI Artifacts", icon: <AiArtifactsGroupIcon th={th} />, items: [
        ...
        { group: "AI Apps", icon: <AiAppsGroupIcon th={th} />, items: [
          ...
          { group: "Grok", icon: <GrokMenuIcon th={th} />, items: [
            { label: "Grok Build", icon: <GrokMenuIcon th={th} />, action: () => decodeAiHistory("grok-build", "Grok Build AI History") },
            { label: "Grok Bot", icon: <GrokBotMenuIcon th={th} />, action: () => decodeAiHistory("grok-bot", "Grok Bot AI History") },
          ] },
      ...
      { section: "Export" },
      { label: "View AI Extraction Coverage", icon: ic(<><circle cx="12" cy="12" r="9"/><path d="M8 12l3 3 5-6"/></>, th.accent), action: () => setModal(openAiHistoryCoverageModal({ tabName: ct?.name, importNotice: ct?.importNotice, importMeta: ct?.aiHistoryImportMeta, failures: ct?.aiHistoryFailures })), disabled: !ct?.dataReady || !isAiHistorySourceFormat(ct?.sourceFormat) || !ct?.aiHistoryImportMeta },
